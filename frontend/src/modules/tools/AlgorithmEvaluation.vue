...
import { useAlgorithmEvaluation } from './composables/useAlgorithmEvaluation'

// The tab, the two form models, the probe list and the two results live in the
// composable; this view keeps the components and the static language list, and
// binds the state into the template below.
const {
